...
- json payloads: 22 (hosts: {'api.nevada.getcarrot.io': 8})
...
- json payloads: 89 (hosts: {'browser-intake-datadoghq.com': 8})
- urls tried: 6
...
- json payloads: 7 (hosts: {'lab.alpineiq.com': 6, 'freeada.skynettechnologies.com': 1})
- product-shaped nodes: 1
